...
export const getLinkForMoviesForGenres = async(genreId:string) =>{
    let result = await axios.get(
        `https://api.themoviedb.org/3/discover/movie?api_key=ca5d667528ca51e527d9e4f7830d97d2&language=en-US&include_adult=false&with_genres=${genreId}`
    );
    return result.data;
}